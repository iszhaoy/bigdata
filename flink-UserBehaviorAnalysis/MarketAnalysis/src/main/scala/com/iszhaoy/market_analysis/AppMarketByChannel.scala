...
// 实现自定义的处理函数
class MarketingCountByChannel() extends ProcessWindowFunction[((String, String), Long), MarketingViewCount, (String,
  String), TimeWindow] {
...
class SimulatedEventSource() extends RichSourceFunction[MarketingUserBehavior] {
  ...
  // 定义渠道的集合
  val channelSets: Seq[String] = Seq("wechat", "weibo", "app_stores", "mi_stores")
