...
import TxMatch.{unmatchPays, unmatchReceipt}
...
object TxMatchOld {
  ...
  val unMatchReceipts: OutputTag[ReceiptEvent] = new OutputTag[ReceiptEvent]("unMatchReceipts")
  ...
  def main(args: Array[String]): Unit = {
    ...
    val processStream = OrderEvent1Stream
      ...
      .process(new TxPayMatchCoProcessFunction())


    processStream.print("match")
    processStream.getSideOutput(unMatchReceipts).print("unmatchReceipt")
  ...
  class TxPayMatchCoProcessFunction() extends CoProcessFunction[OrderEvent1, ReceiptEvent, (OrderEvent1, ReceiptEvent)] {
