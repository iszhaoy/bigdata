...
public class RedisDynamicTableFactory implements  DynamicTableSinkFactory {
    ...
    /**
     * 覆写requiredOptions()和optionalOptions()方法，它们分别返回Connector的必需参数集合和可选参数集合
     * */
    @Override
    public Set<ConfigOption<?>> requiredOptions() {
        Set<ConfigOption<?>> requiredOptions = new HashSet<>();
        requiredOptions.add(SINGLE_HOST);
        requiredOptions.add(SINGLE_PORT);
